...
## Make Plot 4
png(filename="C:/Users/210054296/Documents/2015/Education/Exploratory Data Analysis/Week 1 Assignment/plot4.png")

par(mfrow = c(2, 2))
plot(dataset$extdate,dataset$Global_active_power, type = "l",ylab = "Global Active Power (kilowatts)",xlab="")

plot(dataset$extdate,dataset$Voltage, type = "l",ylab = "Voltage",xlab="datetime")
...
plot(dataset$extdate,dataset$Global_reactive_power, type = "l",ylab = "Global_reactive_power",xlab="datetime")
